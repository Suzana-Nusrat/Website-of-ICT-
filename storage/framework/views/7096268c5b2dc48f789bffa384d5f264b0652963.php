...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.dropdown','data' => ['align' => 'center']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['align' => 'center']); ?>
                             <?php $__env->slot('trigger', null, []); ?> 
                                <span class="inline rounded-md">
                                    <span class="inline items-center border-transparent text-black leading-4 cursor:pointer
                                     font-medium rounded-md text-black-500 bg-transparent hover:bg-gray-50 hover:text-black-700 
                                     focus:outline-none 
                                     focus:bg-gray-50 active:bg-red-50 transition">
                                        <?php echo e(Auth::user()->currentTeam->name); ?>


                                        <svg class="" xmlns="http://www.w3.org/2000/svg"  fill="currentColor">
                                            <path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 
                                            5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 
                                            14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" 
                                            clip-rule="evenodd" />
                                        </svg>
                                    </span>
                                </span>
                             ...
                             <?php $__env->slot('content', null, []); ?> 
                                <div class="w-60">
                                    <!-- Team Management -->
                                    <div class="text-black text-black-400">
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         <?php $__env->slot('trigger', null, []); ?> 
                            <?php if(Laravel\Jetstream\Jetstream::managesProfilePhotos()): ?>
                                <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-black-300 transition">
                                    <img class="h-8 w-2 rounded-full object-cover" src="<?php echo e(Auth::user()->profile_photo_url); ?>" alt="<?php echo e(Auth::user()->name); ?>" />
                                </button>
                            <?php else: ?>
                                <span class="inline-flex rounded-md">
                                    <span class="inline-flex items-center text-xs leading-4 font-medium rounded-md cursor:pointer
                                    text-blue-500 bg-transparent hover:text-red-700 focus:outline-none transition">
                                        <?php echo e(Auth::user()->name); ?>


                                        <svg class="ml--2 -mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="white">
...
<?php /**PATH D:\ xampp1\htdocs\blog\resources\views/navigation-menu.blade.php ENDPATH**/ ?>